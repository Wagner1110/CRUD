            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Tabla de Productos</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Añadir</h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $tabla['descripcion']; ?></th>
                                            <th><?php echo $tabla['fecha_ingreso']; ?></th>
                                            <th><?php echo $tabla['Cantidad']; ?></th>
                                            <th><?php echo "Q ".$tabla['precio']; ?></th>
                                            <th>
                                            <a href="editar.php?id=<?php echo $tabla['id']; ?>" class="btn btn-warning btn-circle btn-sm">
                                        <i class="fas fa-edit"></i></a>
                                        <a href="eliminar.php?id=<?php echo $tabla['id']; ?>"   class="btn btn-danger btn-circle btn-sm">
