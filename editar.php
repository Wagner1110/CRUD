...
<body class="fix-header card-no-border fix-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Registar Productos</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Ingrese</a></li>
                            <li class="breadcrumb-item active">Registar Productos</li>
                        </ol>
                    </div>
  ...
  <?php 
                  ...
                  $sql = "SELECT * FROM Productos WHERE id ='$idR'";
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="descripcion" value="<?php echo $tabla['descripcion']; ?>" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">fecha_ingreso</label>
    <input type="text" class="form-control" name="fecha_ingreso"  value="<?php echo $tabla['fecha_ingreso']; ?>" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Cantidad</label>
    <input type="text" class="form-control" name="Cantidad"  value="<?php echo $tabla['Cantidad']; ?>" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Precio</label>
    <input type="text" class="form-control" name="precio"  value="<?php echo $tabla['precio']; ?>" aria-describedby="emailHelp">
  </div>
